...
class FilerVideoPluginModel(CMSPlugin):
    ...
    autoplay = models.BooleanField(
        ...
        default=False,
        help_text=_(
            'Automatically begin playback of the video as soon as it can do '
            'so without stopping'
        )
    )
    ...
    controls = models.BooleanField(
        ...
        default=False,
        help_text=_(
            'Expose a user interface for controlling playback of the video'
        )
    )
    ...
    loop = models.BooleanField(
        ...
        default=False,
        help_text=_(
            'Seek back to the start of the video upon reaching the end'
        )
    )
